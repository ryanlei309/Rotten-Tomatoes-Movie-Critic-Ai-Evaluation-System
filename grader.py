...
# TODO: train error = 0, validation error = 0.27687113111986494,
# TODO: Yes There are different, I think it is because though train error it's perfect for training data,
#       for validation data remain error exist.
